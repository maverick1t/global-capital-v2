...
const NewsCard: React.FC<NewsCardProps> = ({ item, delay, language }) => {
  ...
  // Logic to get exactly one URL for display with robust fallback
  ...
  if (!rawUrl || rawUrl.length < 5 || rawUrl.toLowerCase() === 'n/a' || rawUrl.toLowerCase() === 'none') {
    // Fallback to Google Search if no valid URL is found
  ...
  return (
    ...
    >
      ...
      <div className="flex-grow space-y-6">
        ...
        {/* Analysis Grid: Opportunities & Risks */}
      ...
      {/* Verified Sources Footer - STRICTLY ONE LINK */}
